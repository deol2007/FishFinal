class Game {
  ...
  async start(){
    ...
    fish1.scale= 0.1;
    fish2 = createSprite(100,20);
    
    fish2.scale= 0.1;
    fish3 = createSprite(100,30);
    
    fish3.scale= 0.1;
    fish4 = createSprite(100,40);
    ...
    if(allPlayers !== undefined){
     ...
     //image(underTheSeaImg,0,-displayHeight*4,displayWidth,displayHeight*5)
      ...
      for(var plr in allPlayers){
        ...
        text("Blue Score = "+ fish1Score, 100, 10)
        text("Green Score = "+ fish2Score, 200, 10)
        text("Yellow Score = "+ fish3Score, 300,10)
        text("Red Score = "+ fish4Score, 400,10)
        //textSize(15);
